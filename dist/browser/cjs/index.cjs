...
var _filter2 = _interopRequireDefault(require("@babel/runtime-corejs3/core-js/instance/filter"));
...
var _toStringTag = _interopRequireDefault(require("@babel/runtime-corejs3/core-js/symbol/to-string-tag"));
...
class FunPromise {
  ...
  static wrap(promise) {
    if (promise instanceof FunPromise) {
      ...
      return new FunPromise(new _promise.default(resolve => resolve(promise)));
    }
  }
  /**
  ...
  processArray(handler) {
    return FunPromise.wrap(this.arrayify().wrapped.then(async inputIterable => {
      const ary = (0, _clone2.default)((0, _castArray2.default)(inputIterable));
  ...
  race(errorHandler) {
    return this.reduceArray(ary => new _promise.default(async (resolver, rejector) => {
      const doResolve = (0, _once2.default)(resolver);
      (0, _forEach2.default)(ary, it => FunPromise.resolve(it).tapFinally(() => {
  ...
  static map(them, mapper) {
    ...
    return (0, _map2.default)(_context = FunPromise.resolve(them)).call(_context, mapper);
  }
  /**
  ...
  map(mapper) {
    return this.reduceArray(ary => _promise.default.all((0, _map3.default)(ary, async it => await mapper(it))));
  }
  /**
   * Given a [[`PromisableIterable`]], resolves each value provided and passes each value through the
   * `mapper` function, collecting the results.
  ...
  static mapSeq(them, mapper) {
    ...
    return (0, _map2.default)(_context2 = FunPromise.resolve(them)).call(_context2, mapper);
  }
  /**
  ...
  static flatMap(them, mapper) {
    ...
    return (0, _flatMap.default)(_context3 = FunPromise.resolve(them)).call(_context3, mapper);
  }
  /**
  ...
  flatMap(mapper) {
    return this.reduceArray(async ary => {
      const results = [];
      await _promise.default.all((0, _map3.default)(ary, async it => {
        await _promise.default.all((0, _map3.default)((0, _toArray2.default)(await mapper(it)), async itsItem => results.push(await itsItem)));
      }));
      return results;
    });
  }
  ...
  flatMapSeq(mapper) {
    return this.reduceArray(async ary => {
      ...
      while (!(0, _isEmpty2.default)(ary)) {
        ...
        await _promise.default.all((0, _map3.default)((0, _toArray2.default)(roundResult), async it => result.push(await it)));
      }
  ...
  fold(initialValue, handler) {
    return this.reduceArray(ary => {
      ...
      return _promise.default.all((0, _map3.default)(ary, async it => {
  ...
  static filter(them, filter) {
    ...
    return (0, _filter2.default)(_context4 = FunPromise.resolve(them)).call(_context4, filter);
  }
  /**
  ...
  filter(test) {
    return this.processArray(async ary => {
      const testResults = await _promise.default.all((0, _map3.default)(ary, test));
  ...
  catchError(handler = _identity2.default) {
    return this.catch(reason => {
      if ((0, _isNil2.default)(reason)) {
        ...
        handler(new Error(`Promise was rejected; expected Error, but saw: ${(0, _toString2.default)(reason)} (${typeof reason})`));
      }
    });
  }
  /**
  ...
  arrayify() {
    return FunPromise.wrap(this.wrapped.then(iterable => (0, _toArray2.default)(iterable)));
  }
  /**
