...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./types", "ts-nested-error", "lodash/defer", "lodash/delay", "lodash/filter", "lodash/flatten", "lodash/identity", "lodash/isEmpty", "lodash/isError", "lodash/isFunction", "lodash/isNil", "lodash/map", "lodash/negate", "lodash/noop", "lodash/toArray"], factory);
    }
    ...
    class FunPromise {
         ...
         */
        tapEach(callback) {
            return this.arrayify(true).tap((ary) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield Promise.all(map_1.default(ary, callback));
            }));
        }
        /**
        ...
        wrapErrors(msg) {
            return this.arrayify().then((ary) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                let errors = [];
                yield Promise.all(map_1.default(ary, (val) => Promise.resolve(val).catch((e) => errors.push(e))));
         ...
         */
        settle() {
            return new FunPromise(this.wrapped.then((value) => new types_1.Fulfillment(value), (reason) => new types_1.Rejection(reason)));
        }
        /**
         ...
         */
        settleAll() {
            return new FunPromise(this.arrayify().wrapped.then((ary) => Promise.all(map_1.default(ary, (val) => Promise.resolve(val).then((value) => new types_1.Fulfillment(value), (reason) => new types_1.Rejection(reason))))));
        }
        /**
         *  Equivalent to `FunPromise.resolve(iterable).settleAll()`.
         */
        static settleAll(iterable) {
            return new FunPromise(Promise.resolve(iterable).then((ary) => Promise.all(map_1.default(ary, (val) => Promise.resolve(val).then((value) => new types_1.Fulfillment(value), (reason) => new types_1.Rejection(reason))))));
        }
    }
