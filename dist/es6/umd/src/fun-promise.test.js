...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./fun-promise", "lodash", "ts-nested-error", "./types"], factory);
    }
    ...
    function withRejection(rejectionReason, callback) {
        ...
        try {
            ...
            rejection.catch(lodash_1.default.noop); // Disable uncaught exception issues
        }
    }
    describe("FunPromise", () => {
        ...
        describe("resolve/return", () => {
            lodash_1.default.forEach({ static: fun_promise_1.default, instance: tokenFunPromise }, (impl, implName) => {
                lodash_1.default.forEach(["resolve", "return"], (methodName) => {
                    describe(methodName, () => {
                        describe(implName, () => {
                            ...
                            it("does not resolve the elements of an array", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                                expect.hasAssertions();
                                yield withRejection("BOOM!", (rejection) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        describe("simplifyAll", () => {
            it("basically works", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                yield expect(fun_promise_1.default.resolve("Hello").simplifyAll()).resolves.toEqual([
                    "H",
                    "e",
                    "l",
                    "l",
            ...
            it("doesn't explode on an empty list", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                yield expect(fun_promise_1.default.resolve([]).simplifyAll()).resolves.toEqual([]);
            }));
        });
        describe("settle", () => {
            it("basically works for rejections", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                yield expect(fun_promise_1.default.reject("BOOM!").settle()).resolves.toHaveProperty("reason", "BOOM!");
            }));
            it("basically works for fulfillments", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                yield expect(fun_promise_1.default.resolve(true).settle()).resolves.toHaveProperty("value", true);
            }));
        });
        describe("settleAll", () => {
            lodash_1.default.forEach([true, false], (staticVersion) => {
                describe(staticVersion ? "static" : "instance", () => {
                    function doSettleAll(values) {
                        if (staticVersion) {
                            return fun_promise_1.default.settleAll(values);
                        }
                        else {
                            return fun_promise_1.default.resolve(values).settleAll();
                        }
                    }
                    it("basically works", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                        const values = [
                            { in: Promise.resolve(true), out: new types_1.Fulfillment(true) },
                            { in: Promise.reject("BOOM!"), out: new types_1.Rejection("BOOM!") },
                            { in: Promise.reject(null), out: new types_1.Rejection(null) },
                            { in: null, out: new types_1.Fulfillment(null) },
                        ];
                        yield expect(doSettleAll(lodash_1.default.map(values, "in"))).resolves.toEqual(lodash_1.default.map(values, "out"));
                    }));
                    it("doesn't explode on empty lists", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
