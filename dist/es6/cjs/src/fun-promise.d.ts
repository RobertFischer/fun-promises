...
/// <reference types="typescript/lib/lib.es2015.promise" />
/// <reference types="typescript/lib/lib.es2020.promise" />
...
export default class FunPromise<T> implements Promise<T> {
    ...
    then<TResult1 = T, TResult2 = TResult1>(onfulfilled: (value: T) => Promisable<TResult1>, onrejected: (reason: any) => Promisable<TResult2>): FunPromise<TResult1 | TResult2>;
    /**
     * Attaches a callback for only the rejection of the Promise.
     * @param onrejected The callback to execute when the Promise is rejected.
     * @returns A Promise for the completion of the callback.
     */
    catch<TResult = never>(onrejected?: (reason: any) => Promisable<TResult>): FunPromise<T | TResult>;
    /**
