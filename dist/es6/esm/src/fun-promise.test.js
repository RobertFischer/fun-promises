...
describe("FunPromise", () => {
                ...
                describe(methodName, () => {
                    describe(implName, () => {
                        ...
                        it("rejects when provided a rejection", () => __awaiter(void 0, void 0, void 0, function* () {
                            yield expect(doResolve(Promise.reject("BOOM!"))).rejects.toBe("BOOM!");
                        }));
                        it("does not resolve the elements of an array", () => __awaiter(void 0, void 0, void 0, function* () {
                            expect.hasAssertions();
                            yield withRejection("BOOM!", (rejection) => __awaiter(void 0, void 0, void 0, function* () {
                                yield expect(doResolve([rejection])).resolves.toHaveLength(1);
                            }));
                        }));
                        describe("resolves correctly", () => {
                            it("with a value", () => __awaiter(void 0, void 0, void 0, function* () {
                                yield expect(doResolve(tokenPromise)).resolves.toBe(true);
                            }));
                            ...
                            it("without a value", () => __awaiter(void 0, void 0, void 0, function* () {
                                yield expect(doResolve()).resolves.toBeNil();
                            }));
                        });
                    });
                });
    ...
    describe("arrayify", () => {
        ...
        it("rejects values when called with the sole argument `true` and a rejection in the mix", () => __awaiter(void 0, void 0, void 0, function* () {
            const rejection = Promise.reject("BOOM!");
    ...
    describe("tap", () => {
        ...
        it("rejects if it throws an exception", () => __awaiter(void 0, void 0, void 0, function* () {
            let sawTap = false;
            yield expect(tokenFunPromise.tap((val) => {
                sawTap = true;
                throw "BOOM!";
    ...
    describe("tapCatch", () => {
        it("basically works", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(FunPromise.reject("BOOM!").tapCatch((e) => {
                sawTapCatch = true;
                expect(e).toBe("BOOM!");
                return "BANG!";
            })).rejects.toBe("BOOM!");
        ...
        it("nests explosions", () => __awaiter(void 0, void 0, void 0, function* () {
            let sawCatch = false;
            const err1 = new Error("BOOM!");
            const err2 = new Error("BANG!");
            yield expect(FunPromise.reject(err1)
                .tapCatch((e) => {
                throw err2;
            })
                .catch((e) => {
    ...
    describe("wrapError", () => {
        it("basically works", () => __awaiter(void 0, void 0, void 0, function* () {
            const reason = "BOOM!";
            yield expect(FunPromise.reject(reason).wrapError("BANG!")).rejects.toHaveProperty("message", "BANG!");
            yield expect(FunPromise.reject(reason).wrapError("BANG!")).rejects.toHaveProperty("innerError");
        }));
    });
    describe("wrapErrors", () => {
        it("basically works", () => __awaiter(void 0, void 0, void 0, function* () {
            const err1 = new Error("BOOM!");
            const err2 = new Error("BANG!");
            yield expect(FunPromise.resolve([Promise.reject(err1), Promise.reject(err2)])
                .wrapErrors("ERRORS!")
                .catch((e) => {
                expect(e).toBeInstanceOf(NestedError);
        ...
        it("doesn't do anything if there is no error", () => __awaiter(void 0, void 0, void 0, function* () {
            const values = [1, 2, 3, true, false, null, undefined];
            yield expect(FunPromise.resolve(values).wrapErrors("ERRORS!")).resolves.toEqual(values);
        }));
    });
    ...
    describe("simplifyAll", () => {
        it("basically works", () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(FunPromise.resolve("Hello").simplifyAll()).resolves.toEqual([
                "H",
                "e",
                "l",
                "l",
        ...
        it("doesn't explode on an empty list", () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(FunPromise.resolve([]).simplifyAll()).resolves.toEqual([]);
        }));
    });
    describe("settle", () => {
        it("basically works for rejections", () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(FunPromise.reject("BOOM!").settle()).resolves.toHaveProperty("reason", "BOOM!");
        }));
        it("basically works for fulfillments", () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(FunPromise.resolve(true).settle()).resolves.toHaveProperty("value", true);
        }));
    });
    describe("settleAll", () => {
        _.forEach([true, false], (staticVersion) => {
            describe(staticVersion ? "static" : "instance", () => {
                ...
                it("basically works", () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    yield expect(doSettleAll(_.map(values, "in"))).resolves.toEqual(_.map(values, "out"));
                }));
                it("doesn't explode on empty lists", () => __awaiter(void 0, void 0, void 0, function* () {
                    yield expect(doSettleAll([])).resolves.toEqual([]);
                }));
            });
        });
    });
