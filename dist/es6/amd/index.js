    ...
    describe("FunPromise", () => {
        ...
        describe("arrayify", () => {
            ...
            it("resolves values when called with the sole argument `true`", () => tslib_3.__awaiter(void 0, void 0, void 0, function* () {
                yield expect(fun_promise_3.default.resolve([
                    Promise.resolve(1),
                    fun_promise_3.default.resolve(2),
                ]).arrayify(true)).resolves.toEqual([1, 2]);
            }));
            it("rejects values when called with the sole argument `true` and a rejection in the mix", () => tslib_3.__awaiter(void 0, void 0, void 0, function* () {
                const rejection = Promise.reject("BOOM!");
        ...
        describe("tapEach", () => {
            it("basically works", () => tslib_3.__awaiter(void 0, void 0, void 0, function* () {
                ...
                const funPromise = fun_promise_3.default.resolve(values);
                let count = 0;
