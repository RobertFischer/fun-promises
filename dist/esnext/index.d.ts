...
export default class FunPromise<T> implements SimplifiedPromise<T> {
     ...
     * [`_.castArray` from Lodash](https://lodash.com/docs/4.17.15#castArray).
     */
    static flatMap<T>(them: PromisableIterable<T>, mapper: any): FunPromise<Unpromise<T>[]>;
    /**
     * `this.map(mapper)` is the same as [[ FunPromise.flatMap | `FunPromise.flatMap(this, mapper)` ]].
     */
    flatMap<U = Element<T>>(mapper: (it: Element<T>) => PromisableIterable<U>): FunPromise<U[]>;
    /**
     * Given a [[`PromisableIterable`]], resolves each value provided and passes each value through the
     * `mapper` function, collecting the results.
     *
     ...
     * [`_.castArray` from Lodash](https://lodash.com/docs/4.17.15#castArray).
     */
    static flatMapSeq<T>(them: PromisableIterable<T>, mapper: any): FunPromise<Unpromise<T>[]>;
    /**
     * `this.flatMapSeq(mapper)` is the same as [[ FunPromise.flatMapSeq | `FunPromise.flatMapSeq(this, mapper)` ]].
     */
    flatMapSeq<U = Element<T>>(mapper: (it: Element<T>) => PromisableIterable<U>): FunPromise<U[]>;
    /**
     ...
     */
    static join<T, U>(left: Promisable<T>, right: Promisable<U>): FunPromise<[T, U]>;
    /**
